...
public class CourseController {
	...
	public ResponseEntity<Page<CourseModel>> getAllCourse(SpecificationTemplate.CourseSpec spec,
		...
		Page<CourseModel> retorno;
		if(userId != null) {
			Specification<CourseModel> courseUserSpec = SpecificationTemplate.coursesUserId(userId).and(spec);
			retorno = courseService.findAll(courseUserSpec, pageable);
		} else {
			retorno = courseService.findAll(spec, pageable);
		}
